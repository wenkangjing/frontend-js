...
this["JST"]["cart_detail"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<li class=\"cart-item\" data-id="
...
this["JST"]["checkout"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<h1>Order Details</h1><table><thead><th>item</th><th></th><th>quantity</th><th>price</th></thead><tbody>"
    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.items : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "</tbody></table><p><small>total:</small><strong>$"
    + container.escapeExpression((helpers.toFixed || (depth0 && depth0.toFixed) || helpers.helperMissing).call(alias1,(depth0 != null ? depth0.price : depth0),{"name":"toFixed","hash":{},"data":data}))
    + "</strong></p>";
},"useData":true});
