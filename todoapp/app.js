...
var nib = require('nib'); // for stylus mixins
...
app.use(express.static(path.join(__dirname, 'public'))); // serve static at the end

// use routers
app.use('/', router); // one and only one router in this SPA project without app state
