...
this["JST"]["card_modal"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"overlay\"><div class=\"card-modal clearfix\"><header><h2><span class=\"icon-lg icon-card indent\"></span><div class=\"card-modal-title\">"
    ...
    + "</textarea><input class=\"card-modal-btn\" type=\"submit\" value=\"Save\"><a class=\"icon-lg icon-close description-close-btn\" href=\"#\"></a></form></div></section><section class=\"comment\"><h2><span class=\"icon-lg icon-comment indent\"></span><span>Add Comment</span></h2><form class=\"add-comment-form\" action=\"\"><span class=\"user-initials indent\"></span><textarea class=\"comment-input\" name=\"comment\" placeholder=\"Write a comment...\"></textarea><input class=\"card-modal-btn\" type=\"submit\" value=\"Send\"></form></section><section class=\"activity\"><h2><span class=\"icon-lg icon-activity indent\"></span><span>Activity</span></h2><ul>"
    ...
    + "</a><a class=\"card-modal-btn-link card-modal-archive\" href=\"#\"><span class=\"icon-sm icon-archive\"></span>&nbsp;Archive</a></section></sidebar></div><script id=\"comment-edit-form\" type=\"text/template\"><form class=\"edit-comment-form\" action=\"\"><span class=\"user-initials indent\"></span><textarea class=\"comment-input\" name=\"comment\" placeholder=\"Write a comment...\"></textarea><input class=\"card-modal-btn\" type=\"submit\" value=\"Send\"></form></script></div>";
},"useData":true});
...
this["JST"]["list"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<header><h2 class=\"list-name-text\">"
    ...
    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.subscribed : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "<a href=\"#\" class=\"list-btn icon-sm dark-hover icon-overflow-menu-horizontal open-list-actions\"></a></div></header><div class=\"cards-wrapper\"><div class=\"cards\"></div></div><a href=\"#\" class=\"list-btn dark-hover open-card-composer\">Add a card...</a>";
},"useData":true});
...
this["JST"]["search_result"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<li class=\"clearfix\" data-id="
    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
    + "><div class=\"card-thumbnail\"><div class=\"card-thumbnail-fade\"></div><header><div class=\"labels\">"
    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.labels : depth0),{"name":"each","hash":{},"fn":container.program(3, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "</div></header><div class=\"name\">"
    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
    + "</div><div class=\"badges\">"
  ...
  return "<div class=\"badge\"><span class=\"icon-sm icon-comment\"></span><span class=\"badge-text\">"
    ...
    return "<div class=\"search-warning\">We couldn't find any cards or boards that matched your search.</div>";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1;

  return "<div class=\"search-result\"><h2>Cards</h2><ul class=\"search-result-cards tabIndex=\"100\">"
    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.cards : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(14, data, 0),"data":data})) != null ? stack1 : "")
    + "</ul><hr><div class=\"search-results-section search-result-help\"><h4>Looking for help using Trello?</h4><p>Visit <a href=\"http://help.trello.com/?source=trello-search\" target=\"help\">our help site</a> or read the <a href=\"https://trello.com/guide?source=trello-search\"target=\"guide\">getting started guide</a></p></div></div>";
},"useData":true});